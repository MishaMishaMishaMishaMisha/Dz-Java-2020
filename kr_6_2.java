...
class kr_6_2
{
	...
	public static void shiftRight(int[][] ar, int n, int steps)
	{
	   ...
	   System.out.printf("«сув вправо на %d позиц≥й\n", steps);
	   showMatr(m, n);
	}	
	...
	public static void shiftLeft(int[][] ar, int n, int steps)
	{
	   ...
	   System.out.printf("«сув вл≥во на %d позиц≥й\n", steps);
	   showMatr(m, n);
	}
	...
	public static void shiftUp(int[][] ar, int n, int steps)
	{
	   ...
	   System.out.printf("«сув вгору на %d позиц≥й\n", steps);
	   showMatr(m, n);
	}
	...
	public static void shiftDown(int[][] ar, int n, int steps)
	{
	   ...
	   System.out.printf("«сув вниз на %d позиц≥й\n", steps);
	   showMatr(m, n);
	}
